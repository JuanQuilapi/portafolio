  ...
  return (
    <nav className={`${styles.navbar} ${scrolled ? styles.scrolled : ""}`}>
      <div className={styles.container}>
        <h1 className={styles.logo}>Juan Quilapi</h1>
        <ul className={styles.navLinks}>
          ...
          <li>
            <a
              href="https://github.com/JuanQuilapi"
              target="_blank"
              rel="external"
              className={`${[styles.socialLink, styles.navLink].join(" ")}`}
            >
              <svg
          ...
          <li>
            <a
              href="https://www.linkedin.com/in/juan-quilapi-jordan/"
              target="_blank"
              rel="external"
              className={`${[styles.socialLink, styles.navLink].join(" ")}`}
            >
