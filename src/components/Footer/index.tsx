    ...
    <footer className={styles.footer}>
      <div className={styles.footerContent}>
        <p className={styles.text}>
          Esta página está hecha usando React,TypeScript y CSS, se encuentra en
          mejora continua para agregar nuevas funcionalidades.
        </p>
        <a
          href="https://github.com/JuanQuilapi/portafolio"
          target="_blank"
